...
class TestQuiz(unittest.TestCase):
    ...
    def setUp(self):
        self.QuizInput = QUIZ(1001, 1, "Introduction to IBM WorkCentre", 
        "Introduction", null, 1)
    ...
    def test_JSON(self):
        ...
        JsonCheck = {'quizID': 1001, 'CNo': 1, 'course_name': 'Introduction to IBM WorkCentre', 
        'chapter_name': 'Introduction', 'duration': null, 'total_questions': 1}
